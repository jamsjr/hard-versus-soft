...
\begin{figure*}[t]
  ...
  \subfloat[Execution costs for the trace of 'eve'.]{
    \includegraphics[angle=270,scale=0.35]{trace-eve}
    \label{fig:plot-trace-eve}
  }
  \subfloat[Normally distributed execution costs over time.]{
    \includegraphics[angle=270,scale=0.35]{trace-normal}
...
\begin{figure}[t]
  \centering
  \includegraphics[angle=270,scale=0.35]{trace-trifasico}
...
\begin{figure*}[t]
  ...
  \subfloat[Soft reservation.]{
    \includegraphics[angle=270,scale=0.35]{trifasico-1}
    \label{fig:soft-trifasico}
  }
  \subfloat[Hard reservation.]{
    \includegraphics[angle=270,scale=0.35]{trifasico-2}
...
\begin{figure*}[t]
  \centering
  \subfloat[Soft reservation.]{
    \includegraphics[angle=270,scale=0.35]{variance-1}
    \label{fig:soft-variance}
  }
  \subfloat[Hard reservation.]{
    \includegraphics[angle=270,scale=0.35]{variance-2}
...
\begin{figure*}[t]
  \centering
  \subfloat[Soft reservation.]{
    \includegraphics[angle=270,scale=0.35]{eve-1}
    \label{fig:soft-eve}
  }
  \subfloat[Hard reservation.]{
    \includegraphics[angle=270,scale=0.35]{eve-2}
    \label{fig:hard-eve}
  }
