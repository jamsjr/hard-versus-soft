...
\item L4: A movie trace. The execution cost distribution are shown in
  ...
  reservation schemes with a real-life data set.
\end{description}
...
\begin{table}[ht]
  ...
  \begin{tabular}[t]{rrrrr} \hline
    ...
    L1 & Soft & $5.1\times 10^{-1}$   & $1.1\times 10^{-1}$   & 5.4  \\
    L1 & Hard & $5.6\times 10^{-1}$   & $1.2\times 10^{-1}$   & 59.8 \\
    L2 & Soft & $4.8\times 10^{-1}$   & $1.2\times 10^{-1}$   & 14.4 \\
    L2 & Hard & $4.4\times 10^{-1}$   & $1.7\times 10^{-1}$   & 37.5 \\
    L3 & Soft & $5.7\times 10^{-1}$   & $8.0\times 10^{-2}$   & 5.1  \\
    L3 & Hard & $5.8\times 10^{-1}$   & $1.2\times 10^{-1}$   & 59.4 \\
    L4 & Soft & $6.5\times 10^{-3}$   & $3.3\times 10^{-4}$   & 0.1  \\
    L4 & Hard & $3.5\times 10^{-2}$   & $5.6\times 10^{-3}$   & 24.5 \\ \hline    
  \end{tabular}
